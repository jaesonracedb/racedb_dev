              ...
              <form>
                ...
                <div class="row ml-4">
                  ...
                  <div class="col-lg-3 ml-3">
                    ...
                    <option id="running">Running</option>
                    <option id="cycling">Cycling</option>
                    <option id="triathlon">Triathlon</option>
                    <option id="obstacle">Obstacle</option>
                ...
                <div class="row ml-4">
                  ...
                  <div class="col-lg-2 ml-3">
                    <input type="text" name="distanceIn" class="form-control" placeholder="Input race Distance" onChange={this.handleDistance} required/><br/>
                  </div>
                  <div class="col-xs ml-3">
                    <a> Swim Distance: </a>
                  </div>
                  <div class="col-lg-2 ml-3">
                    <input type="text" id="swimDistance" class="form-control" name="swim_distanceIn" placeholder="Input swim distance" onChange={this.handleSwimDistance} required/><br/>
                  </div>
                </div>
                <div class="row ml-4">
                  <div class="col-xs ml-3">
                  ...
                  <div class="col-lg-2 ml-3">
                    <input type="text" id="bikeDistance" class="form-control" name="bike_distanceIn" placeholder="Input bike distance" onChange={this.handleBikeDistance} required/><br/>
                  </div>
                  <div class="col-xs ml-3">
                    <a> Run Distance: </a>
                  </div>
                  <div class="col-lg-2 ml-3">
                    <input type="text" id="runDistance" class="form-control" name="run_distanceIn" placeholder="Input run distance" onChange={this.handleRunDistance} required/><br/>
                  </div>
                </div>
                <div class="row ml-4">
                  <div class="col-xs ml-3">
                ...
                <div class="row ml-4">
                  ...
                  <div class="col-lg-2 ml-3">
                    <input type="text" name="race_typeIn" class="form-control" placeholder="Input race type" onChange={this.handleRaceType} required/><br/>
                  </div>
                  <div class="col-xs ml-3">
                    <a> Cycling Type: </a>
                  </div>
                  <div class="col-lg-2 ml-3">
                    <input type="text" id="CyclingType" class="form-control" name="cycling_typeIn" placeholder="Input cycling type" onChange={this.handleCyclingType} required/><br/>
                  </div>
                </div>
              </form>
              <div class="row ml-4">
